...
const Landing = () => {
  // Function for smooth scroll when clicking "View Specs"
  const scrollToSpecs = () => {
    const element = document.getElementById('system-demo');
    if (element) {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <section className="pt-56 pb-32 max-w-7xl mx-auto px-10 grid grid-cols-12 gap-16 items-center">
        <div className="col-span-12 lg:col-span-7">
          ...
          <div className="flex gap-4">
            <Link to="/dashboard" className="bg-[#bef35e] text-black px-10 py-4 rounded-full font-black uppercase text-xs tracking-widest flex items-center gap-2 hover:shadow-[0_0_30px_rgba(190,243,94,0.3)] transition-all">
              Get Started <ArrowRight size={18} />
            </Link>
            {/* Functional View Specs Button */}
            <button 
      ...
      {/* SYSTEM DEMO SECTION (Video Placeholder) */}
      <section id="system-demo" className="max-w-7xl mx-auto px-10 py-32 mb-40">
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-500 uppercase tracking-widest text-[10px] font-black italic">A technical walkthrough of Project Aura's core engine</p>
        </div>
        
        {/* Large Rectangular Video Placeholder */}
        <div className="aura-card w-full aspect-video rounded-[3rem] overflow-hidden relative group cursor-pointer border-white/10 bg-black/60 flex items-center justify-center">
            ...
            {/* Corner UI Elements to make it look technical */}
            <div className="absolute top-8 left-10 text-zinc-700 font-mono text-[10px] uppercase tracking-widest">Live_Playback_Ready</div>
            <div className="absolute bottom-8 right-10 text-zinc-700 font-mono text-[10px] uppercase tracking-widest">Duration: 04:20</div>
        </div>
      </section>
    </div>
  );
